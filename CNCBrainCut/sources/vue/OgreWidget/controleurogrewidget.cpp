...
int ControleurOgreWidget::creat3DBloc(Bloc * bloc){
    if(bloc->getNodeBloc3d() != NULL)
    {
        ...
        if( (bloc->getDimention().x <= BBSize) || (bloc->getDimention().z <= BBSize) || (bloc->getDimention().z <= BBSize))
        {
        ...
        beginSegment(blocContour01, bloc->getSommet0(), bloc->getSommet1(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour12, bloc->getSommet1(), bloc->getSommet2(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour23, bloc->getSommet2(), bloc->getSommet3(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour30, bloc->getSommet3(), bloc->getSommet0(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour04, bloc->getSommet0(), bloc->getSommet4(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour45, bloc->getSommet4(), bloc->getSommet5(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour51, bloc->getSommet5(), bloc->getSommet1(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour37, bloc->getSommet3(), bloc->getSommet7(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour76, bloc->getSommet7(), bloc->getSommet6(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour62, bloc->getSommet6(), bloc->getSommet2(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour47, bloc->getSommet4(), bloc->getSommet7(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
        ...
        beginSegment(blocContour56, bloc->getSommet5(), bloc->getSommet6(), BBSize, Ogre::ColourValue::Blue, bloc->getSegmentMatName().toStdString(), false);
...
void ControleurOgreWidget::beginSegment(Ogre::ManualObject * segment, Ogre::Vector3 debut, Ogre::Vector3 fin, int BBRayon, Ogre::ColourValue couleur, Ogre::String matName, bool isUpDate)
{
    ...
    segment->position(debut);
    segment->colour(couleur);

    segment->position(fin);
    segment->colour(couleur);
    segment->end();
...
void ControleurOgreWidget::changeSegmentColot(Ogre::MovableObject * segment, Ogre::ColourValue color){
    ...
    if(segment != NULL)
    {
        ...
        if(found!=std::string::npos)
        {
            ...
            if(Found)
                beginSegment(((Ogre::ManualObject *) segment), min, max,10,color,"",true);
            m_Vue3D->update();
        }
    }
}
